    ...
    <div class="page-wrapper p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Complete Your Registration here | You need approval before login</h2>
                    ...
                    <form method="post" action="{{route('regconfirm.store')}}">
                      @csrf
                        ...
                        <div class="row row-space">
                              <div class="col-2">
                                  <div class="input-group">
                                      <input class="input--style-1" type="text" placeholder="WEBSITE" name="website" required oninput="this.reportValidity()">
                                  </div>
                              </div>

                              <div class="col-2">
                                  <div class="input-group">
                                      <input class="input--style-1" type="number" placeholder="ESTABLISHED YEAR" name="year" required oninput="this.reportValidity()">
                                  </div>
                              </div>
