        ...
        <div class="hotel-search-form-area"  style="margin-top:8%;">
             <div class="container-fluid">
                 <div class="hotel-search-form">
                     <form method="POST" action="/generatelink2">

                     @csrf
                         <div class="row justify-content-between align-items-center">
                             <div class="col-6 col-md-2 col-lg-3">
                                 <label for="carname">Email</label>
                                 <input type="emnail" class="form-control" name="email" required>
                                
                                 @if(isset($success))
                                   {{$success}}
                                   @endif
                                   <button type="submit" class="form-control btn roberto-btn w-100">Invite</button>
