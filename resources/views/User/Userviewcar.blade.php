	...
	<!--section class="section-booking bg1-pattern p-t-100 p-b-110"-->
		<div class="container">
				...
				<div class="col-lg-12 p-b-30">
					...
					<form action="/comments" class="wrap-form-booking" method="post" enctype="multipart/form-data">
			...
			<div class="panel-group" id="accordion2">
				...
				<div style="margin-left:300px;">
									<center><input type="submit" class="form-control btn-success" value="Add Rating" style="width:800px;"></center>
				</div>
					</form>
